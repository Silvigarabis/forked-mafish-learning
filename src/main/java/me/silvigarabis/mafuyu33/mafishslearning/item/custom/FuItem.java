...
import me.silvigarabis.mafuyu33.mafishslearning.entity.FuProjectileEntity;
...
public class FuItem extends AxeItem {
    public FuItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
