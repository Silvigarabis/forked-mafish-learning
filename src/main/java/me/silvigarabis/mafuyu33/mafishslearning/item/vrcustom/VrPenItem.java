...
import static me.silvigarabis.mafuyu33.mafishslearning.VRPlugin.isPlayerInVR;
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if(isDrawing){//画笔
            if(world.isClient) {
                ...
                if(count<=1) {//单画笔
                    if (entity instanceof PlayerEntity user && isPlayerInVR(user)) {//有MC-VR-API并且在VR中的时候
                    ...
                    if (entity instanceof PlayerEntity user && isPlayerInVR(user)) {//VR
